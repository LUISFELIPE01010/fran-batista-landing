  ...
  return <div className="min-h-screen bg-white font-poppins">
        ...
        <div className="container mx-auto max-w-6xl grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button onClick={() => window.open(instagramLink, '_blank')} className="bg-rose-burned hover:bg-rose-burned/90 text-white px-8 py-6 text-lg rounded-full shadow-lg transition-all duration-300 hover:scale-105">
                <Instagram className="w-5 h-5 mr-2" />
                Seguir no Instagram
              </Button>
              <Button onClick={() => window.open(emailContact, '_blank')} variant="outline" className="border-rose-burned text-rose-burned hover:bg-rose-burned hover:text-white px-8 py-6 text-lg rounded-full shadow-lg transition-all duration-300 hover:scale-105">
          ...
          <div className="relative animate-scale-in">
            <div className="relative w-full max-w-md mx-auto">
              <img alt="Fran Batista - Nutricionista" className="w-full h-auto rounded-3xl shadow-2xl" src="/lovable-uploads/2c7f697e-34c5-43a6-b762-8e2d6eefc18b.jpg" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 pt-4">
                <Button onClick={() => window.open(instagramLink, '_blank')} className="bg-rose-burned hover:bg-rose-burned/90 text-white rounded-full px-6 py-3 transition-all duration-300 hover:scale-105">
                  <Instagram className="w-4 h-4 mr-2" />
                  @nutrifranbatista
                </Button>
                <Button onClick={() => window.open(emailContact, '_blank')} variant="outline" className="border-rose-burned text-rose-burned hover:bg-rose-burned hover:text-white rounded-full px-6 py-3 transition-all duration-300 hover:scale-105">
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-white to-nude">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {specialties.map(specialty => <Card key={specialty.id} className="group cursor-pointer border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white rounded-3xl overflow-hidden">
                <CardContent className="p-8">
                  ...
                  <Button onClick={() => handleSpecialtyClick(specialty.id)} className="w-full bg-rose-burned hover:bg-rose-burned/90 text-white rounded-full transition-all duration-300 hover:scale-105">
                    Quero saber mais
                    <ArrowRight className="w-4 h-4 ml-2" />
                  </Button>
                  
                  {selectedSpecialty === specialty.id && <div className="mt-6 p-6 bg-pink-light rounded-2xl animate-slide-up">
                      <p className="text-gray-rose mb-4">{specialty.description}</p>
                      <div className="space-y-2 mb-6">
                        {specialty.benefits.map((benefit, index) => <div key={index} className="flex items-center gap-2">
                            <CheckCircle className="w-4 h-4 text-rose-burned" />
                            <span className="text-sm text-gray-rose">{benefit}</span>
                          </div>)}
                      </div>
                      <div className="flex gap-3">
                        <Button onClick={() => window.open(instagramLink, '_blank')} className="flex-1 bg-rose-burned hover:bg-rose-burned/90 text-white rounded-full transition-all duration-300 hover:scale-105">
                          <Instagram className="w-4 h-4 mr-2" />
                          Instagram
                        </Button>
                        <Button onClick={() => window.open(emailContact, '_blank')} variant="outline" className="flex-1 border-rose-burned text-rose-burned hover:bg-rose-burned hover:text-white rounded-full transition-all duration-300 hover:scale-105">
                          <Mail className="w-4 h-4 mr-2" />
                          Email
                        </Button>
                      </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {tips.map((tip, index) => <Card key={index} className="group cursor-pointer border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white rounded-3xl overflow-hidden hover:scale-105">
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-nude to-pink-light">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {instagramPosts.map(post => <Card key={post.id} className="group cursor-pointer border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white rounded-3xl overflow-hidden hover:scale-105">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button onClick={() => window.open(instagramLink, '_blank')} size="sm" className="bg-rose-burned hover:bg-rose-burned/90 text-white rounded-full transition-all duration-300 hover:scale-105">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-4xl">
          ...
          <Card className="border-0 shadow-xl bg-white rounded-3xl overflow-hidden">
            <CardContent className="p-8">
              {quizStep < quizQuestions.length ? <div className="space-y-6">
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="w-24 h-2 bg-pink-light rounded-full">
                      <div className="h-full bg-rose-burned rounded-full transition-all duration-300" style={{
                  ...
                  <div className="grid gap-3">
                    {quizQuestions[quizStep].options.map((option, index) => <Button key={index} onClick={() => handleQuizAnswer(option)} variant="outline" className="p-4 text-left justify-start border-pink-light hover:bg-pink-light hover:border-rose-burned transition-all duration-300 rounded-2xl">
                        {option}
                      </Button>)}
                  </div>
                  ...
                  <div className="flex gap-4 justify-center">
                    <Button onClick={() => window.open(instagramLink, '_blank')} className="bg-rose-burned hover:bg-rose-burned/90 text-white px-8 py-4 rounded-full shadow-lg transition-all duration-300 hover:scale-105">
                      <Instagram className="w-5 h-5 mr-2" />
                      Instagram
                    </Button>
                    <Button onClick={() => window.open(emailContact, '_blank')} variant="outline" className="border-rose-burned text-rose-burned hover:bg-rose-burned hover:text-white px-8 py-4 rounded-full shadow-lg transition-all duration-300 hover:scale-105">
                      <Mail className="w-5 h-5 mr-2" />
                      Email
                    </Button>
                  </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-pink-light to-nude">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => <Card key={index} className="border-0 shadow-lg bg-white rounded-3xl overflow-hidden hover:scale-105 transition-all duration-300">
                <div className="aspect-video overflow-hidden">
                  <img src={testimonial.image} alt={testimonial.name} className="w-full h-full object-cover" />
                </div>
                <CardContent className="p-8 text-center">
                  <div className="flex justify-center mb-4">
                    {[...Array(5)].map((_, i) => <Star key={i} className="w-5 h-5 text-rose-burned fill-current" />)}
                  </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {moreTestimonials.map((testimonial, index) => <Card key={index} className="border-0 shadow-lg bg-gradient-to-br from-nude to-pink-light rounded-3xl hover:scale-105 transition-all duration-300">
                <CardContent className="p-8">
                  <div className="flex justify-center mb-4">
                    {[...Array(5)].map((_, i) => <Star key={i} className="w-5 h-5 text-rose-burned fill-current" />)}
                  </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-nude to-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {feedbacks.map((feedback, index) => <Card key={index} className="border-0 shadow-lg bg-white rounded-3xl hover:scale-105 transition-all duration-300">
                <CardContent className="p-6 text-center">
                  <div className="mb-4">
                    <p className="text-sm font-medium text-rose-burned mb-2">{feedback.platform}</p>
                    <div className="flex justify-center">
                      {[...Array(feedback.rating)].map((_, i) => <Star key={i} className="w-4 h-4 text-rose-burned fill-current" />)}
                    </div>
                  </div>
          ...
          <div className="text-center space-y-8">
            <div className="grid md:grid-cols-3 gap-8 items-center">
              <div className="text-center">
                <img src="/lovable-uploads/a48297bd-5b37-4a99-962b-a25e6cb671ec.png" alt="Fran Batista" className="w-24 h-24 rounded-full mx-auto mb-4 object-cover border-4 border-white shadow-lg" />
              ...
              <div className="flex flex-col gap-4">
                <Button onClick={() => window.open(instagramLink, '_blank')} className="bg-white text-rose-burned hover:bg-white/90 rounded-full px-6 py-3 transition-all duration-300 hover:scale-105">
                  <Instagram className="w-5 h-5 mr-2" />
                  Instagram
                </Button>
                <Button onClick={() => window.open(emailContact, '_blank')} variant="outline" className="border-white text-white hover:bg-white hover:text-rose-burned rounded-full px-6 py-3 transition-all duration-300 hover:scale-105">
                  <Mail className="w-5 h-5 mr-2" />
                  Email
                </Button>
              </div>
